...
RUN mkdir -p /mongo-r${MONGO_VERION}/build/install/bin && echo msg:${CCFLAGS} > /mongo-r${MONGO_VERION}/build/install/bin/xyz && echo 'abc' > /mongo-r${MONGO_VERION}/build/install/bin/abc
